...
public class booking {
    ...
    public static void booking(){
        ...
        {
            choiceBox.getItems().add(tripList.get(i).source);
            choiceBox2.getItems().add(tripList.get(i).des);
        }
